...
public class TestClause {
  ...
  public void testFrom() {
    ...
    Assert.assertEquals("t", clause.getTableRef().getTableName());
  ...
  public void testOrderBy() {
    ...
    Assert.assertEquals(Direction.DESC, clause.getOrderByItems().get(1).getDirection());
  ...
  public void testSet() {
    ...
    clause.setValue("a", 1);
    System.out.println(clause);
    Assert.assertEquals("a", clause.getSetItems().get(0).getColumn().getColumn());
